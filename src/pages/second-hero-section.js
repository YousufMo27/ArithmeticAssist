...
export default function SecondHero () {
    return <div className={AppCss["second-hero-background"]}>
        <div className={AppCss["second-hero-txt"]}>
